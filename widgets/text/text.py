...
class TextWidget(tk.Tk):
    ...
    def configure_window(self):
        ...
        self.configure(bg=self.config_data.get("text_bg", "black"))
    ...
    def create_text(self):
        text_content = self.config_data.get("text_c", "Example content")
        self.text_label = tk.Label(
            self,
            text=text_content,
            font=("Consolas", self.BASE_FONT, "bold"),
            fg=self.config_data.get("text_text", "white"),
            bg=self.config_data.get("text_bg", "black"),
            padx=20,
            pady=10,
        )
    ...
    def update_text(self):
        ...
        self.text_label.config(font=("Consolas", font_size, "bold"))
    ...
    def apply_colors(self):
        ...
        self.text_label.config(
            fg=self.config_data.get("text_text", "white"), bg=bg,
            text=self.config_data.get("text_c", "Example content")
        )
